...
<title>用户信息修改</title>
<script type="text/javascript" src="<%=path %>/js/user/updateUser.js"></script>
<style type="text/css">
	table{
		width:400px;
...
<body>
	<center>
	<form action="<%=path %>/user/updateUser.do?userNo=${userVo.userNo}&?type=1&isAppro=${isAppro}" name="formName" id="formID" method="post">
		<table>
			<tr>
