...
function test1() {
	var now = new Date();
	alert(now.Format("yyyy-MM-dd hh:mm"));
}

// 返回两时间比较结果
function check2date(str1,str2){
	var i=0;
	while(str1.charAt(i)==str2.charAt(i)){
		i=i+1;
	}
	return str1.charAt(i)>str2.charAt(i)?true:false;
}
...
// 日期格式化// 格式 YYYY/yyyy/YY/yy 表示年份// MM/M 月份// W/w 星期// dd/DD/d/D 日期// hh/HH/h/H
// 时间// mm/m 分钟// ss/SS/s/S 秒
Date.prototype.Format = function (formatStr) {
	var str = formatStr;
	var Week = ["\u65e5", "\u4e00", "\u4e8c", "\u4e09", "\u56db", "\u4e94", "\u516d"];// 日一二三四五六
...
function StringToDate(DateStr) {
	...
	if (isNaN(myDate)) {// var delimCahar = DateStr.indexOf('/')!=-1?'/':'-';
