...
function fDrawCal(iYear, iMonth, iCellHeight, sDateTextSize) {
  ...
  var styleTitleTD = " bgcolor='"+gcTitleBG+"' bordercolor='"+gcTitleBG+"' valign='middle' align='center' height='"+iCellHeight+"' style='font-size:"+sDateTextSize+"px; ";
  var styleTD = " bgcolor='"+gcBG+"' bordercolor='"+gcBG+"' valign='middle' align='center' height='"+iCellHeight+"' style='font-size:"+sDateTextSize+"px; ";
...
with (document) {
write("<Div id='VicPopCal' name='VicPopCal' style='OVERFLOW:hidden;POSITION:absolute;VISIBILITY:hidden;border:0px ridge;width:100%;height:100%;top:0;left:0;z-index:100;'>");
...
write("</SELECT>");
write("&nbsp;<select id='tbSelMonth' name='tbSelMonth' onChange='fUpdateCal(tbSelYear.value, tbSelMonth.value)' Victor='Won'>");
for (i=0; i<12; i++)
