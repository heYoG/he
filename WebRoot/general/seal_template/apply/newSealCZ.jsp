...
function GetDate(nText) {
	...
	<body class="bodycolor" topmargin="5" onload="load_do();">
		...
		<html:form action="sealTempAdd.do" method="post" styleId="form1" target="menu_main">
			...
			<tr>
					...
					<td nowrap class="TableData">
						<input type="text" name="able_btime" size="10"
				...
				<tr>
					...
					<td class="TableData">
						<input class="BigStatic" name="approve_user" type="hidden" value=${appMan_id }>
						<input class="BigStatic" name="approve_name" type="text" readonly value=${appMan_name }>
