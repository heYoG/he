...
<html>
	<head>
		...
		<script src="/Seal/general/hotel/record/js/waitDeal_list.js"></script>
						...
						<form id="f_sch" action="" method="post" name="form1">
							<table class="TableBlock" id="tb_info" width="100%">
								<tr>
									...
									<td nowrap class="TableData">
										<strong>身份证号：</strong><input type="hidden" id="createuserid" name="createuserid" />
										<input type="text" id="cardNo" name="cardNo" />
									</td>
									<td nowrap class="TableData">
										<strong>单据类型：</strong>
										<select id="mtplid" name="mtplid"></select>
									</td>
									<td nowrap class="TableData">
										<strong>单据状态：</strong>
