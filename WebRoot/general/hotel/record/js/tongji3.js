...
var cdt_f={};
var reg="";//判断
var thisUrl=baseUrl(3)+"Seal/general/hotel/record/tongji3.jsp";
...
function list_load(d){
	...
	showData();
	show_sch();
	document.getElementById("showname").innerHTML=dept_name;
}
...
function getDatas(){
	dwr.engine.setAsync(false); //设置方法调用是否同步，false表示同步
	HotelRecord.getTongJi3(cdt_f,cb_data);
}
