...
<html>
	<head>
		...
		<script type='text/javascript' src='/Seal/dwr/interface/NSHHotelRecord.js'></script>
							...
							<table class="TableBlock" id="tb_info" width="100%" cellpadding="0" cellspacing="0">
								<tr>
									<td nowrap class="TableData">
										<strong>柜员号码: </strong><input type="text" id="tellerNo" name="tellerNo" />
									</td>
									<td nowrap class="TableData">
										<strong>机构号: </strong><input type="text" id="orgunit" name="orgunit" />
									</td>
									<td nowrap class="TableData">
									...
									<td nowrap class="TableData">
										<strong>CEID: </strong><input type="text" id="ceid" name="ceid" />
									</td>
								...
								<tr align="center">
									<td colspan="6" align="center" class="TableData">
