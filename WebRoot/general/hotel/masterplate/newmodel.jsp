...
<html>
	<head>
		...
		<script src="/Seal/general/hotel/masterplate/js/newmodel.js"
				...
				<table class="TableList" width="80%" align="center">
					<tr>
						...
						<td class="TableControl">
							<input type="button" value="新建模板"
								onclick="loadAip(0);" class="SmallButton" />
						</td>
					</tr>
				...
				<tr>
					<td align="center">
						<input style="display: none" type="button" onclick="showNew();"
							value="新增文档" />
						<input type="button" value="查询" onclick="show_sch()"/>
					</td>
				</tr>
			</table>
		</div>
				...
				<table class="TableList" id="tb_info" align="center">						
					...
					<tr>
						<td colspan="2" align="center" nowrap class="TableControl">
							...
							<input type="button" value="返回" class="BigButton" onclick="ret()"/>
						</td>
					</tr>
				</table>
			</form>
