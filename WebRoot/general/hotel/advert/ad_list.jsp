...
<html>
	<head>
		...
		var user_ip="${user_ip}";
		var user_dept="${current_user.dept_no}";
		if(user_no==""){
	...
	<body class="bodycolor" onload="list_load(user_dept);">
		...
		<center>
			...
			<div id="detail" class="ModalDialog" style="width: 550px;">
				...
				<div id="apply_body" class="body" align="center">
					<form id="f_editad" enctype="multipart/form-data" action="" method="post" name="form1">
