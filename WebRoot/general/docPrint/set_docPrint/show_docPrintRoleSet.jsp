...
<script src="/Seal/general/docPrint/set_docPrint/js/show_docPrintRoleSet.js"></script><!-- 用于使用DWR查询时分页 -->
...
<table border="0" width="100%" cellspacing="10" cellpadding="3">
	...
	<tr>
		<td>
			<div id="div_Roletable">
			</div>
		</td>
	</tr>
	<tr>
		<td>
			<div class="pager" align="left" id="pager"><!-- 按角色的翻页部分 -->
			</div>
		</td>
	</tr>
</table>
