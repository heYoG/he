var obj=new QerTable("role_list");
var page=1;
var pageSize=10;
var cdt_s="";
var cdt_f={};
var doc_no="";
var thisUrl=baseUrl(3)+"Seal/general/docPrint/set_docPrint/show_docPrintRoleSet.jsp";
...
function tb_create(){
	$("div_Roletable").innerHTML=obj.HtmlCode();
...
//   alert(cdt_f.status_busi);
	DocPrintService.showRoleSet(page,pageSize,doc_no,cdt_f,cb_data);
}
function cb_data(ps){
	if(ps.datas){
		obj.Clean();
...
function updatePrint(user_id,doc_no){
	...
	DocPrintService.updateDocPrintRoleUserbyRoleid(user_id,doc_no,newPrintNum,updateCallback);
}
