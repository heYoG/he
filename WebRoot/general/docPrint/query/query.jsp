		...
		<table border="0" width="100%" cellspacing="0" cellpadding="3"
			...
			<tr>
				<td class="Big">
					...
					<span class="big3">文档查询</span>
				</td>
			</tr>
		</table>
		<form action="docQuery.do?type=flag3" method="post" name="form1">
			<table class="TableBlock" width="90%" align="center">
				<tr>
					...
					<td nowrap class="TableData">
						<input type="text" name="doc_no" class="BigInput" size="40"
							maxlength="20">
						&nbsp;
					</td>
				</tr>
				<tr>
					...
					<td nowrap class="TableData">
						<input type="text" name="doc_name" class="BigInput" size="40"
							maxlength="20">
						&nbsp;
					</td>
				</tr>
				<tr>
					...
					<td nowrap class="TableData">
						<input type="text" name="doc_title" class="BigInput" size="40"
							maxlength="20">
						&nbsp;
					</td>
				</tr>
				...
				<tr>
					...
					<td nowrap class="TableData">
						...
						<input type="text" id="start_time" name="start_time" size="10" maxlength="10"
						...
						至&nbsp;
						<input type="text" id="end_time" name="end_time" size="10" maxlength="10"
							class="BigInput" onfocus="this.blur()">
				...
				<tr>
					<td nowrap class="TableControl" colspan="2" align="center">
						<input type="button" value="查询" class="BigButton"
							onclick="CheckForm('../../../docQuery.do?type=flag3');" title="文档查询" name="button">
						&nbsp;&nbsp;
