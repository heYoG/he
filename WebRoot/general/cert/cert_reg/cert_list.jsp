...
<html>
	<head>
		...
		<script src="/Seal/general/cert/cert_reg/js/cert_list.js"></script>
				...
				<form id="f_sch" action="" method="post">
					<table class="TableBlock" id="tb_info">
						...
						<tr>
							...
							<td nowrap class="TableData">
								<textarea name="busi_discript" rows="6" cols="50"
									class="BigInput" onblur="checkDn();"></textarea>
								<br>
							</td>
						</tr>
						<tr>
