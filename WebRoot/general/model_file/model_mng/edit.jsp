...
var obj = $("HWPostil1");
obj.ShowDefMenu = false; //���ز˵�
obj.ShowToolBar = false; //���ع�����
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="3"
			...
			<tr>
				<td class="Big">
					...
					<span class="big3">�༭ģ��</span><span class="small"
						style="color: red;">(��ģ���������϶���������ӳ������)</span>
				</td>
				<td align=right>
					<input type="button" class="SmallButton" value="���ӳ������"
						onclick="addField()" />
					&nbsp;
