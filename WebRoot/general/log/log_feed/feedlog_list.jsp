...
<html>
	<head>
		...
		<script type='text/javascript' src='/Seal/dwr/interface/FeedLogSys.js'></script>
		...
		<script src="/Seal/general/log/log_feed/js/feedlog_list.js"></script>
			...
			<div id="d_search" style="display: none">
				<form id="f_sch" action=""  name="form1" method="post">
					...
					<td nowrap class="TableData">
						<input type="text" name="create_user" class="BigInput" size="20"
							maxlength="20">
						&nbsp;
					</td>
				</tr>
				<tr>
					...
					<td nowrap class="TableData">
						<input type="text" name="piaohao_id" class="BigInput" size="20"
							maxlength="20">
						&nbsp;
					</td>
				</tr>
