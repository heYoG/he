...
<html>
	<head>
		...
		<script type='text/javascript' src='/Seal/dwr/interface/DocSrv.js'></script>
		...
		<script src="/Seal/general/log/seal_oper/js/showDoc.js"></script>
