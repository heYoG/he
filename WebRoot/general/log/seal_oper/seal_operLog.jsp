...
<html>
	<head>
		...
		<script src="/Seal/general/log/seal_oper/js/seal_operLog.js"></script>
			...
			<div id="d_search" style="display: none">
				<form id="f_sch" action=""  name="form1" method="post">
					...
					<td nowrap class="TableData">
						<input type="text" id="seal_name" name="seal_name" class="BigInput" size="20"
							maxlength="20">
						&nbsp;
					</td>
				</tr>
				<tr>
					...
					<td nowrap class="TableData">
						<input type="text" id="user_name" name="user_name" class="BigInput" size="20"
							maxlength="20">
						&nbsp;
					</td>
				</tr>
				<tr>
					...
					<td nowrap class="TableData">
						<input type="text" id="user_ip" name="user_ip" class="BigInput" size="20"
							maxlength="20">
						&nbsp;
					</td>
				</tr>
