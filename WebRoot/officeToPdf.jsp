...
{         
	...
	document.forms[0].action="/Seal/Interface/show.jsp";
}
//获取xml内容
function sel_file(){
var fso;
...
window.location.href="http://127.0.0.1:8080/Seal/docs/download3.jsp?name="+docName+".pdf";
  ...
  <body>
   <form action="/Seal/Interface/show.jsp" method="post" name="Regsiter" target="_blank">
 ...
 <input name="button" width="500px" height="500px" type="button" value="HTML5文档保存" onclick="doSubmit('html5save');" />
  <input name="button" width="500px" height="500px" type="button" value="office转换pdf" onclick="doSubmit('officeToPdf');" />
   <!--
