package com.dj.seal.gaizhangRule.form;

import org.apache.struts.action.ActionForm;

public class GaiZhangRuleForm extends ActionForm {
	...
	private String use_cert;// 是否使用证书
	...
	public String getUse_cert() {
		return use_cert;
	}
	public void setUse_cert(String use_cert) {
