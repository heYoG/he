...
public class UpdHotelAdvertAction extends BaseAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		f.setAd_dept(request.getAttribute("dept").toString());
		...
		if(imagename!="1"){
			f.setImagename(request.getAttribute("imagename").toString());
		...
		f.setAd_id(request.getAttribute("id").toString());
		advertService.updateAdvert(f);
