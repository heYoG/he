package com.dj.seal.modelFile.vo;
...
public class ModelFileVo {
	...
	private String approve_status;// 审批状
	private Timestamp approve_time;// 审批时间
	private String approve_reason;
	private String use_range;// 模版使用范围（保留字段）
	private String modelorxieyi;// 模版还是协议 0是模板 1是协议
	private String feiqi_status; // 0 未废弃 1 废弃
	private String modelwidth;// 模板宽度 mm单位
	private String modelheight;// 模板高度 mm单位
	...
	public String getFeiqi_status() {
		return feiqi_status;
	}

	public void setFeiqi_status(String feiqi_status) {
		this.feiqi_status = feiqi_status;
	}
