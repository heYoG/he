...
public class DesUtils {
		static Logger logger = LogManager.getLogger(DesUtils.class.getName());
	  /** 字符串默认键值     */
...
//	    return new String(decrypt(hexStr2ByteArr(strIn)));//windows
		  return new String(decrypt(hexStr2ByteArr(strIn)),"UTF-8");//linux
	  }
      //解密有效期
	  ...
	  public static void main(String[] args) {
	    try {
	      ...
	      String test = "451acc8d9af01f60d1c85cf9d2df2989";//加密原文
	     // String test = "测试系统";//加密原文
	      DesUtils des=null;
    ...
    // des=new DesUtils(strUnitKey);//单位授权
	      ...
	      logger.info("解密后的字符：" + des.decrypt(des.encrypt(test)));
	    }
	    catch (Exception e) {
